                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4 col-lg-4">
                        ...
                        <div class="input date">
                            <input class="form-control" type="date" id="birth" name="birth" value="<?php echo $user->birth->format('Y-m-d')?>">
                    ...
                    <div class="col-md-1 col-lg-1">
                        <label class="text-start"><?=__('usuario ativo')?></label>
                    ...
                    <div class="col-md-4 col-lg-4">
                        ...
                        <?php  echo $this->Form->control('id_igreja', ['class' => 'form-control', 'label' => false, 'options' => $igrejas, 'value' => $user->id_igreja]); ?>
                    </div>
